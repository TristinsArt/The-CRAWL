---
{"dg-publish":true,"permalink":"/spells/imprisonment/"}
---
...
**_Chaining_**
Heavy chains, firmly rooted in the ground, hold the target in place. The target is [[Rules/References/Conditions/Restrained\|restrained]] until the spell ends, and it can't move or be moved by any means until then.
...
A [[Spells/Dispel Magic\|Dispel Magic]] spell can end the spell only if it is cast as a 9th-level spell, targeting either the prison or the special component used to create it.
